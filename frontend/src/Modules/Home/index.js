					...
					<div className="wrapper">
						<div className="about section">
							<div className="col content-col">
								...
								<p className="section-text">
									Lorem ipsum dolor sit amet consectetur adipisicing elit. In illo error tempora a excepturi porro
									labore suscipit odit dolor obcaecati, aliquid odio, officia architecto natus quos quod voluptate
									alias velit.
								</p>
						...
						<div className="location section">
							<div className="col content-col">
								...
								<p className="section-text">
									Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est at, dolores quisquam tenetur
									voluptas vitae nam, hic quae repellendus modi assumenda reprehenderit et dignissimos atque sunt
									ullam. Pariatur, quasi a?
								</p>
								<button className="section-button-arrow-dark">
									<p>Locations</p>
									<span><i className="fa-solid fa-arrow-right"></i></span>
						...
						<div className="merchandise section">
							<div className="content-col">
								...
								<div className="row-button">
									<button className="section-button-center-dark">ORDER NOW</button>
									<button className="section-button-center-light">ALL ITEM</button>
								</div>
							</div>
						</div>
					</div>
					<div className="promo section">
						<div className="wrapper">
							<div className="promo-item">
								...
								<div className="col">
									<h3 className="title">
										Buy 1 Large, Get FREE 1 Regular
									</h3>
									<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iste, impedit dolor consectetur,
										magnam odit.</p>
									<div className="row">
